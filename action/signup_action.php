<?php 
	...
	if (isset($_POST['submit-signup_student']))
	{
		...
		$student_number = str_replace(["-", "–"], '', $_POST['student_number']);;
		...
		if ($password == $re_password)
		{
			...
			{	
				...
				if ($res['student_status'] == 'unregister') {
					...
					$result = mysqli_query($con,"INSERT INTO `user_account` (user_level, user_name, user_password) VALUES ('1','$student_number','$password1')");

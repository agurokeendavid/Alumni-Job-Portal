<?php 
	...
	if (isset($_POST['Submit'])) {
		...
		if ($chk = mysqli_query($con,$chk)){
			$sql = "UPDATE `user_teacher_detail` SET teacher_facultyID = '$teacher_tfinumber', teacher_fName = '$teacher_firstname', teacher_mName = '$teacher_middlename', teacher_lName = '$teacher_lastname', teacher_gender = '$teacher_gender', teacher_dob = '$teacher_bday', teacher_contact = '$teacher_contact', teacher_address = '$teacher_adress', teacher_civilStat = '$teacher_civilStat' , teacher_department = '$teacher_department'";
